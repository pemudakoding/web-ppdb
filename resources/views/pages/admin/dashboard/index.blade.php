...
<div class="col-md-12 col-lg-6">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Total Pendaftar Berdasarkan Agama</h6>
        </div>
        <div class="card-body">
            <div class="chart-bar">
                <div class="chartjs-size-monitor">
                ...
                <canvas id="pendaftar_agama" style="display: block; width: 673px; height: 320px;" width="673"
                    height="320" class="chartjs-render-monitor"></canvas>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script>
        ...
        var agama = document.getElementById("pendaftar_agama");
        ...
        var myBarChart = new Chart(agama, {
            type: 'bar',
            data: {
                labels: [
            ...
            options: {
                ...
                scales: {
                    ...
                    yAxes: [{
                        ticks: {
                            min: 0,
                            max: {{ $totalPendaftarAgama[0]->total }},
                            maxTicksLimit: 5,
                            padding: 10,
                            stepSize: 1
                        },
